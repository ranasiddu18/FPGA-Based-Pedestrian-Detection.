...
#
# Script generated by Vivado on Fri Mar 27 23:05:41 +0530 2026
...
# script info
echo -e "testbench.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot testbench xil_defaultlib.testbench xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/vivado/2025.2/Vivado/data/xsim"
  fi
...
Usage: testbench.sh [-rerun]\n\
Usage: testbench.sh [-reset_run]\n\
Usage: testbench.sh [-clean]\n\
